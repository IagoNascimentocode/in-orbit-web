...
import { RadioGroupIndicator, RadioGroupItem, RadioGroup } from "./ui/radio-group";
  ...
  return (
    <DialogContent>
      <div className='flex flex-col gap-6 h-full'>
        ...
        <form onSubmit={handleSubmit(hanldeCreateGoal)} className='flex-1 flex flex-col gap-4 justify-between'>
          <div className='flex flex-col gap-6'>
            <div className='flex flex-col gap-2'>
              <Label htmlFor='title'>Qual a atividade?</Label>
              <Input className="text-zinc-50"
                id='title'
                autoFocus
